...
public class ReservasView extends JFrame {
		...
		txtFechaS.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				...
				if (txtFechaE.getDate() != null) {
					try {
						reserva.setValor(txtFechaE.getDate(), txtFechaS.getDate());
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtFechaE.getDate() != null && ReservasView.txtFechaS.getDate() != null) {
					setReserva(ReservasView.txtFechaE.getDate(), ReservasView.txtFechaS.getDate(),
							ReservasView.txtFormaPago.getSelectedItem().toString());
					try {
						reservaController.guardar(reserva, ReservasView.txtFechaE.getDate(),
	...
	private void setReserva(java.util.Date entraDate, java.util.Date SalidaDate, String tipoPago) {
		reserva.setFechaEntrada(new Date(entraDate.getTime()));
		reserva.setFechaSalida(new Date(SalidaDate.getTime()));
