...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		inputFactory.SetInput(txtNombre);
		...
		inputFactory.SetInput(txtApellido);
		...
		inputFactory.SetInput(txtTelefono);
		...
		inputFactory.SetInput(txtNreserva);
		txtNreserva.setText(Integer.toString(reservaController.getLastId()));
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (inputNotNull() && txtFechaN.getDate() != null) {
					try {
						huesped = new Huesped(txtNombre.getText(), txtApellido.getText(),
								new Date(txtFechaN.getDate().getTime()), (String) txtNacionalidad.getSelectedItem(),
								Long.parseLong(txtTelefono.getText()));
						huespedController.guardar(huesped, Integer.parseInt(txtNreserva.getText()));
	...
	private boolean inputNotNull() {
		for (JTextField input : inputFactory.getInstances()) {
